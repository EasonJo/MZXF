...
class AppLifecyclesImpl : AppLifecycles {
    ...
    override fun onCreate(application: Application) {
        ...
        //leakCanary内存泄露检查
        //ArmsUtils.obtainAppComponentFromContext(application).extras().put(RefWatcher::class.java!!.getName(), if (BuildConfig.USE_CANARY) LeakCanary.install(application) else RefWatcher.DISABLED)
